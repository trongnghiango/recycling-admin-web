import { getTwoLatestItemFromPathString } from "@/utils/utils";
  ...
  const onChangeHandler = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    Array.from(event.target.files).forEach((file) => {
      if (
        ...
        const raw = getTwoLatestItemFromPathString(file.webkitRelativePath);
        // console.log('ITEMMMMMM::', raw)
        const thenum = raw?.match(/\d+/);
